...
void vec3::Add(const long double& other)
    {
	x += other;
	y += other;
	z += other;
...
void vec3::Substract(const long double& other)
    {
	x -= other;
	y -= other;
	z -= other;
...
void vec3::Multiply(const long double& other)
    {
	x *= other;
	y *= other;
	z *= other;
...
void vec3::Divide(const long double& other)
    {
	x /= other;
	y /= other;
	z /= other;
